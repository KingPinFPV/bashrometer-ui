...
// Interfaces (ensure these match your API responses)
...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchProductDetails = async () => {
      setIsLoading(true);
      setError(null);
      // IMPORTANT: Ensure this API URL is correct and your API server is running
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Report Price Button (only if user is logged in) */}
      {user && product && ( // Ensure product is not null
